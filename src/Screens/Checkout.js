...
numberOfLines={1}/>
   ...
   <View style={styles.container2}>
<TextInput style={{height:45,width:'100%',backgroundColor:'#fff',paddingLeft:5,marginTop:-40}}
   placeholder="Address"
...
<View style={styles.container2}>
   <TextInput style={{ height:45,width:'48%',backgroundColor:'#fff',paddingLeft:5,marginTop:-80}}
...
<View style={styles.container2}>
<TextInput style={{height:45,width:'100%',backgroundColor:'#fff',paddingLeft:5,marginTop:-120}}
   placeholder="email"
   ...
   numberOfLines={1}/>
           ...
           <View style={styles.container2}>
           <TouchableOpacity
style={{backgroundColor: "#000", height: 50,width:'100%',marginTop:45}}
