...
class Products extends React.Component {
    ...
    fetchData = async() => {
        ...
        fetch('https://dreamdesigners.rkhomeappliances.co.in/wp-json/wc/v2/products?per_page=100&consumer_key=ck_6583bdf76fe9b8d80b98880bf009bb9f03ba819e&consumer_secret=cs_603630202af533fd87ac134c55441c69bcfa4d93');
        //posts //Highlights
    ...
    render() {
        ...
        return (
           <Container style={styles.maincontent}>
            ...
            <Text style={{textAlign:'center',fontSize:18,marginTop:10}}> { product.meta_data[1].value[0] + ' Working Days'}</Text>
